package org.flixel
{
	...
	public class FlxTilemap extends FlxObject
	{
		...
		public function loadMap2(MapData:String, TileGraphic:Object, TileWidth:uint=0, TileHeight:uint=0, AutoTile:uint=OFF, StartingIndex:uint=0, DrawIndex:uint=1, CollideIndex:uint=1):FlxTilemap
		{
			auto = AutoTile;
			_startingIndex = StartingIndex;
			...
			//Figure out the size of the tiles
			_tiles = FlxG.addBitmapFromObject(TileGraphic);
			_tileWidth = TileWidth;
			if(_tileWidth == 0)
				_tileWidth = _tiles.height;
			_tileHeight = TileHeight;
