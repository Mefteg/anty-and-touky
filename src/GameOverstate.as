package  
{
	...
	public class GameOverstate extends State 
	{
		...
		public function GameOverstate()
		{
			...
			Global.library.addBitmap("Images/Menu/gameover.jpg");
		}
		...
		override public function create() : void {
			...
			m_mvcBackground = new MVCButton("Menu/gameoverbackground.xml");
			m_mvcButton = new MVCButton("Menu/gameoverstate.xml");
		}
